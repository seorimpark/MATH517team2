...
Below is the plot of two example states that are not neighbouring from each other, New York and California: the percentages of new COVID--19 cases over the total state population in New York and California are plotted as a function of time. 
...
Below is the plot of two example states that are neighbouring from each other, Nevada and California. We can observe that compared to the previous graph, the plots seem to look more alike. 
