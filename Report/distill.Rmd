...
```{r, echo = FALSE}
plot(df_us$end_date, df_us$mortality_10000, type = "o", ylab ="Mortality rate ", xlab = "Time (in months)",main = "Figure (7):Number of deaths for 10 000 individuals per month")
```
...
plot(df_us$end_date, df_us$cases_10000, type= "o", ylab = "Cases rate", xlab = "Time(in months) ",main = "Figure (8): Number of cases for 10 000 individuals per month")
```
...
for (i in 1:length(new_cases)){
  cases[i]= sum(new_cases[1:i-1])
}
cases[1]= 0
df_us$cases = cases
ratio = df_us$new_deaths_per_month/df_us$cases
plot(df_us$end_date, ratio, type = "o", ylab ="Proportion of deaths ", xlab = "Time (in months)",main = "Figure (10): Ratio of the number of death and the new cases for 10 000 individuals per month")
