...
plot(df_us$end_date, ratio, type = "o", ylab ="Proportion of deaths ", xlab = "Time (in months)",main = "Ratio of the number of death and the new cases for 10 000 individuals per month")
