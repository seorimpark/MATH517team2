...
We have shown that the geolocation also has an impact on the number of cases, and that it is possible to predict the number of cases and deaths based on the numbers from the neighboring states. 
